...
app.all('*' , (req,res,next)=>{
  if(req.secure){    // if the request is over https then req.secure is true
    return next();
  }
  else{
    res.redirect(307 , 'https://' + req.hostname + ':' + app.get('secPort') + req.url); // secPort is defined in /bin/www
